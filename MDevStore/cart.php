                   ...
                   <p class="text-muted">You currently have <?php echo $count; ?>item(s) in your cart</p>
                           ...
                           <tbody><!-- tbody Begin -->
                              <?php 
                               ...
                               <tr><!-- tr Begin -->
                                   ...
                                   <td>
                                       <a href="details.php?pro_id=<?php echo $pro_id; ?>"> <?php echo $product_title; ?>
                                       </a>
                                   </td>
                                   <td>
                                       <?php echo $pro_qty; ?>
                    ...
                    <div class="box-footer"><!-- box-footer Begin -->
                        ...
                        <div class="pull-right"><!-- pull-right Begin -->
                            <button type="submit" name="update" value="Update Cart" class="btn btn-default" method="post"><!-- btn btn-default Begin -->
